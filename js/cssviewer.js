...
function CSSViewer_build_semanticUI_button_variables() {
  ...
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@backgroundColor: " + CSSViewer_computedStyle.getPropertyValue('background-color') + ";\n";
  CSSViewer_semanticUI_button_variables += "@backgroundImage: " + CSSViewer_computedStyle.getPropertyValue('background-image') + ";\n";
  CSSViewer_semanticUI_button_variables += "@boxShadow: " + CSSViewer_computedStyle.getPropertyValue('box-shadow') + ";\n";
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@hoverBackgroundColor: '';\n";
  CSSViewer_semanticUI_button_variables += "@hoverBackgroundImage: ''\n";
  ...
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@activeBackgroundColor: '';\n";
  CSSViewer_semanticUI_button_variables += "@activeBackgroundImage: '';\n";
  ...
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@basicFontWeight: '';\n";
  ...
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@basicHoverBackground: '';\n";
  CSSViewer_semanticUI_button_variables += "\n";
  CSSViewer_semanticUI_button_variables += "@primaryColor: '';\n";
  CSSViewer_semanticUI_button_variables += "@secondaryColor: '';\n";
  CSSViewer_semanticUI_button_variables += "\n";
